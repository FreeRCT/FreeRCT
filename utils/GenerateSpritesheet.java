...
public class GenerateSpritesheet {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("  -a --anim NAME           Animation name for the rcdgen code.");
		System.out.println("     --fps                 Frames per second for the rcdgen code.");
		System.out.println();
		...
		if (emitCode != null) {
			...
			if (animName != null) {
				write.println(animName + ": TIMA {");
				write.println("fps: " + fps + ";");
				write.println("frames: " + frames_to_render + ";");
			}
			for (int f = 0; f < frames_to_render; ++f) {
			...
			if (animName != null) write.println("}");
			write.close();
		}
