		...
		Widget(WT_PANEL, INVALID_WIDGET_INDEX, COL_RANGE_DARK_RED),
			Intermediate(3, 1),
				...
				Intermediate(5, 4),
					...
					Widget(WT_TEXT_PUSHBUTTON, GTRMW_ENTRANCE_FEE_INCREASE, COL_RANGE_DARK_RED), SetData(GUI_INCREASE_BUTTON, STR_NULL), SetRepeating(true),
					Widget(WT_LEFT_TEXT, INVALID_WIDGET_INDEX, COL_RANGE_DARK_RED), SetData(GUI_GENTLE_THRILL_RIDES_MANAGER_CYCLES_TEXT, STR_NULL),
					Widget(WT_TEXT_PUSHBUTTON, GTRMW_CYCLES_DECREASE, COL_RANGE_DARK_RED), SetData(GUI_DECREASE_BUTTON, STR_NULL), SetRepeating(true),
					Widget(WT_CENTERED_TEXT, GTRMW_CYCLES, COL_RANGE_DARK_RED), SetData(STR_ARG1, STR_NULL),
					Widget(WT_TEXT_PUSHBUTTON, GTRMW_CYCLES_INCREASE, COL_RANGE_DARK_RED), SetData(GUI_INCREASE_BUTTON, STR_NULL), SetRepeating(true),
					Widget(WT_LEFT_TEXT, INVALID_WIDGET_INDEX, COL_RANGE_DARK_RED), SetData(GUI_RIDE_MANAGER_MIN_IDLE_TEXT, STR_NULL),
					Widget(WT_TEXT_PUSHBUTTON, GTRMW_MIN_IDLE_DECREASE, COL_RANGE_DARK_RED), SetData(GUI_DECREASE_BUTTON, STR_NULL), SetRepeating(true),
					Widget(WT_CENTERED_TEXT, GTRMW_MIN_IDLE, COL_RANGE_DARK_RED), SetData(STR_ARG1, STR_NULL),
					Widget(WT_TEXT_PUSHBUTTON, GTRMW_MIN_IDLE_INCREASE, COL_RANGE_DARK_RED), SetData(GUI_INCREASE_BUTTON, STR_NULL), SetRepeating(true),
					Widget(WT_LEFT_TEXT, INVALID_WIDGET_INDEX, COL_RANGE_DARK_RED), SetData(GUI_RIDE_MANAGER_MAX_IDLE_TEXT, STR_NULL),
					Widget(WT_TEXT_PUSHBUTTON, GTRMW_MAX_IDLE_DECREASE, COL_RANGE_DARK_RED), SetData(GUI_DECREASE_BUTTON, STR_NULL), SetRepeating(true),
					Widget(WT_CENTERED_TEXT, GTRMW_MAX_IDLE, COL_RANGE_DARK_RED), SetData(STR_ARG1, STR_NULL),
					Widget(WT_TEXT_PUSHBUTTON, GTRMW_MAX_IDLE_INCREASE, COL_RANGE_DARK_RED), SetData(GUI_INCREASE_BUTTON, STR_NULL), SetRepeating(true),
					Widget(WT_LEFT_TEXT, INVALID_WIDGET_INDEX, COL_RANGE_DARK_RED), SetData(GUI_RIDE_MANAGER_MAINTENANCE_TEXT, STR_NULL),
					Widget(WT_TEXT_PUSHBUTTON, GTRMW_MAINTENANCE_DECREASE, COL_RANGE_DARK_RED), SetData(GUI_DECREASE_BUTTON, STR_NULL), SetRepeating(true),
					Widget(WT_CENTERED_TEXT, GTRMW_MAINTENANCE, COL_RANGE_DARK_RED), SetData(STR_ARG1, STR_NULL),
					Widget(WT_TEXT_PUSHBUTTON, GTRMW_MAINTENANCE_INCREASE, COL_RANGE_DARK_RED), SetData(GUI_INCREASE_BUTTON, STR_NULL), SetRepeating(true),
