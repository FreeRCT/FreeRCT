...
void ShopInstance::Load(Loader &ldr)
{
	...
	if (version != CURRENT_VERSION_ShopInstance) ldr.version_mismatch("ShopInstance", version, CURRENT_VERSION_ShopInstance);
...
{
	svr.PutLong(CURRENT_VERSION_ShopInstance);
