		...
		Widget(WT_PANEL, INVALID_WIDGET_INDEX, COL_RANGE_DARK_RED),
			Intermediate(2, 1),
				Intermediate(4, 4),
					...
					Widget(WT_TEXT_PUSHBUTTON, CIW_ENTRANCE_FEE_INCREASE, COL_RANGE_DARK_RED), SetData(GUI_INCREASE_BUTTON, STR_NULL), SetRepeating(true),
					Widget(WT_LEFT_TEXT, INVALID_WIDGET_INDEX, COL_RANGE_DARK_RED), SetData(GUI_RIDE_MANAGER_MIN_IDLE_TEXT, STR_NULL),
					Widget(WT_TEXT_PUSHBUTTON, CIW_MIN_IDLE_DECREASE, COL_RANGE_DARK_RED), SetData(GUI_DECREASE_BUTTON, STR_NULL), SetRepeating(true),
					Widget(WT_CENTERED_TEXT, CIW_MIN_IDLE, COL_RANGE_DARK_RED), SetData(STR_ARG1, STR_NULL),
					Widget(WT_TEXT_PUSHBUTTON, CIW_MIN_IDLE_INCREASE, COL_RANGE_DARK_RED), SetData(GUI_INCREASE_BUTTON, STR_NULL), SetRepeating(true),
					Widget(WT_LEFT_TEXT, INVALID_WIDGET_INDEX, COL_RANGE_DARK_RED), SetData(GUI_RIDE_MANAGER_MAX_IDLE_TEXT, STR_NULL),
					Widget(WT_TEXT_PUSHBUTTON, CIW_MAX_IDLE_DECREASE, COL_RANGE_DARK_RED), SetData(GUI_DECREASE_BUTTON, STR_NULL), SetRepeating(true),
					Widget(WT_CENTERED_TEXT, CIW_MAX_IDLE, COL_RANGE_DARK_RED), SetData(STR_ARG1, STR_NULL),
					Widget(WT_TEXT_PUSHBUTTON, CIW_MAX_IDLE_INCREASE, COL_RANGE_DARK_RED), SetData(GUI_INCREASE_BUTTON, STR_NULL), SetRepeating(true),
					Widget(WT_LEFT_TEXT, INVALID_WIDGET_INDEX, COL_RANGE_DARK_RED), SetData(GUI_RIDE_MANAGER_MAINTENANCE_TEXT, STR_NULL),
					Widget(WT_TEXT_PUSHBUTTON, CIW_MAINTENANCE_DECREASE, COL_RANGE_DARK_RED), SetData(GUI_DECREASE_BUTTON, STR_NULL), SetRepeating(true),
					Widget(WT_CENTERED_TEXT, CIW_MAINTENANCE, COL_RANGE_DARK_RED), SetData(STR_ARG1, STR_NULL),
					Widget(WT_TEXT_PUSHBUTTON, CIW_MAINTENANCE_INCREASE, COL_RANGE_DARK_RED), SetData(GUI_INCREASE_BUTTON, STR_NULL), SetRepeating(true),
