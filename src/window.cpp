 ...
 */
bool Window::OnKeyEvent(WmKeyCode key_code, uint16 mod, const std::string &symbol)
{
	return false;
}
...
bool GuiWindow::OnKeyEvent(WmKeyCode key_code, uint16 mod, const std::string &symbol)
{
 ...
 * @return Key event has been processed.
 */
bool WindowManager::KeyEvent(WmKeyCode key_code, uint16 mod, const std::string &symbol)
{
	for (Window *w = this->top; w != nullptr; w = w->lower) {
